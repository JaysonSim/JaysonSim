...
<div style="display: flex; justify-content: space-between;">
  <div style="flex: 1; padding: 10px; max-width: 48%; display: flex; flex-direction: column;">
    <a href="https://github.com/JaysonSim/AudioStream" style="flex: 1; display: block;">
  ...
  <div style="flex: 1; padding: 10px; max-width: 48%; display: flex; flex-direction: column;">
    <a href="https://github.com/JaysonSim/VoiceLine" style="flex: 1; display: block;">
